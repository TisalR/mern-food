...
const generatePDF = tickets => {
    ...
    doc.text("Food Craves Pvt Ltd", 70, 8).setFontSize(13);
    doc.text("Employee Details Report", 14, 16).setFontSize(13);
...
<input type="text" placeholder="Search.." className="form-control" style={{margintop:50,marginbottom:20,width:"50%"}}
   ...
   <button type="text" class="btnq btnq--skew btnq-default"> Employee Count : {employee.length} </button>
